...
folder are mapped to the application's root namespace, 'proyekgabutSencha'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "proyekgabutSencha"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'proyekgabutSencha' in the same way
as `"proyekgabutSencha/sass/src"`.
